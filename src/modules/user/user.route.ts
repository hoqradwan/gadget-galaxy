...
import { addProductToOrder, createUser, deleteSingleUser, getAllOrders, getAllUsers, getSingleUser, totalPriceOfOrders, updateSingleUser } from "./user.controller";
...
router.get("/users/:userId/orders/total-price", totalPriceOfOrders);
